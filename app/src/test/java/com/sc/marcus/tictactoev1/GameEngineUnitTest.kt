...
class GameEngineUnitTest {
    ...
    /*
    @Test
    fun shouldReturnTrueIfMiddleTileIsEmpty() {
        val mutableArray1 = mutableListOf(1, 3)
        val mutableArray2 = mutableListOf(1, 2)


        assertTrue(aiEngine.checkIfMiddleTitleOrEndingTile(mutableArray1, winningList))
    }
    */

    /*
    @Test
    fun shouldBlockMiddleShort() {
        val test1Xarray = mutableListOf(1, 3)
        val test1Oarray = mutableListOf(4)
        val updatedOArray1 = mutableListOf(4, 2)


        assertEquals(aiEngine.blockTileMiddle(test1Xarray, test1Oarray, winningList), updatedOArray1)
    }

    @Test
    fun shouldBlockMiddleLong() {
        val test1Xarray = mutableListOf(6, 9)
        val test1Oarray = mutableListOf(4, 2)
        val updatedOArray1 = mutableListOf(4, 2, 1)
    ...
    @Test
    fun shouldBlockEnd() {
        val test1Xarray = mutableListOf(6, 9, 1)
        val test1Oarray = mutableListOf(4)
        val updatedOArray1 = mutableListOf(4, 3)

        assertEquals(aiEngine.blockTileEnd(test1Xarray, test1Oarray, winningList), updatedOArray1)
    }

    @Test
    fun shouldReturnFalseIfEndTileIsEmpty() {
        val mutableArray1 = mutableListOf(1, 2)

        assertFalse(aiEngine.checkIfMiddleTitleOrEndingTile(mutableArray1, winningList))
    } */
}
